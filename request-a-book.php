                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT tblbook.BookName,tblbook.Copies,tblbook.isIssued,tblcategory.CategoryName,tblauthors.AuthorName,tblbook.ISBNNumber,tblbook.BookPrice,tblbook.id as bookid from  tblbook join tblcategory on tblcategory.id=tblbook.CatId join tblauthors on tblauthors.id=tblbook.AuthorId";
